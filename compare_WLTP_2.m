...
y = WLTP_Class_2_Rule.cap_info.signals(7).values(:,:);
plot(x, y, 'g')
...
y = WLTP_Class_2_Rule.bat_info.signals(6).values;
plot(x, y, 'g')
...
y = WLTP_Class_2_Rule.bat_info.signals(7).values(:,:);
plot(x, y, 'g')
...
y = WLTP_Class_2_Rule.bat_info.signals(8).values(:,:);
plot(x, y, 'g')
...
wltp_class_2_rule_bat_avg = mean(WLTP_Class_2_Rule.Bat_Power.signals.values);
